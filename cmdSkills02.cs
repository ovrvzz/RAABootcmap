...
namespace RevitAddinBootcamp
{
    ...
    public class cmdSkills02 : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            TaskDialog.Show("Test", $"I selected {pickList.Count} elements."); //$"..." puts out interpolated strings, i.e. "the output is {} and {}"
            ...
            {
                t.Start("create a wall"); //start the transaction
                ...
                // 13. switch statement - similiar to if..else if..else if...else if..else
                int numberValue = 5;
                string numberAsString = "";

                switch (numberValue) //checking for the number value 
                {
                    case 0:                         //is the number value 0? 
                        numberAsString = "Zero";    //print Zero
                        break;                      //if match is found, stop 
                    ...
                    default:                        //if none of the previous conditions exist, print 99
